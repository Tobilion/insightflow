...
- **Portfolio** — tobiloba-jagun-portfolio.vercel.app (React 19 + TS + Vite + Tailwind v4, Framer Motion, Spline 3D)
...
- Plus: Duplicate File Analyzer, InsightFlow (Python desktop tools)
